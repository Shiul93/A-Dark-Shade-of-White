...
class BotonReanudar(Boton):
	def __init__(self, pantalla):
		Boton.__init__(self, pantalla, 'humo.png', (260, 160))
	def accion(self):
		self.pantalla.menu.reanudarPartida()
		
class BotonMenu(Boton):
	def __init__(self, pantalla):
		Boton.__init__(self, pantalla, 'humo.png', (260, 340))
	def accion(self):
		self.pantalla.menu.cargarMenu()

class BotonSalir(Boton):
	def __init__(self, pantalla):
		Boton.__init__(self, pantalla, 'humo.png', (260, 520))
	def accion(self):
...
class TextoReanudar(TextoGUI):
	def __init__(self, pantalla):
		# La fuente la debería cargar el estor de recursos
		fuente = pygame.font.SysFont('arial', 26);
		TextoGUI.__init__(self, pantalla, fuente, (255, 255, 255), 'Reanudar Partida', (280, 130))
	def accion(self):
		self.pantalla.menu.reanudarPartida()

class TextoMenu(TextoGUI):
	def __init__(self, pantalla):
		# La fuente la debería cargar el estor de recursos
		fuente = pygame.font.SysFont('arial', 26);
		TextoGUI.__init__(self, pantalla, fuente, (255, 255, 255), 'Volver al Inicio', (310, 310))
	def accion(self):
		self.pantalla.menu.cargarMenu()
...
class TextoSalir(TextoGUI):
	def __init__(self, pantalla):
		# La fuente la debería cargar el estor de recursos
		fuente = pygame.font.SysFont('arial', 26);
		TextoGUI.__init__(self, pantalla, fuente, (255, 255, 255), 'Salir', (350, 480))
	def accion(self):
		self.pantalla.menu.salirPrograma()
