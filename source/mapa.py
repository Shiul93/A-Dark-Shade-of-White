...
class Mapa:
    ...
    def load_layers(self):
        ...
        for layer in self.layers:
            ...
            if layer[0]==0 :
                self.images[layer[1]]= GestorRecursos.CargarImagenMapa(self.path,layer[5]).convert()
            else:
                self.images[layer[1]]= GestorRecursos.CargarImagenMapa(self.path,layer[5],-1).convert()
